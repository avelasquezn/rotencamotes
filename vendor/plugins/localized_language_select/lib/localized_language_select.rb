...
module LocalizedLanguageSelect
  class << self
    ...
    def localized_languages_array(language_codes=nil)
      language_codes = language_codes ? language_codes : I18n.translate(:languages).keys
      language_codes.map {|key| [I18n.translate(:"languages.#{key}"), key] }.sort
    end
